...
bech32_templates = [
  ...
  ('indx',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('indx',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('indx',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('indx',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('indxt',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('indxt',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('indxt',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('indxt',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('indxt',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('indxt',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('indxt',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('indxt',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('indxrt',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('indxrt',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('indxrt',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('indxrt', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, encoding, invalid_bech32, invalid_checksum, invalid_char
  ('tind',    0, 20, Encoding.BECH32,  False, False, False),
  ('ind',    1, 32, Encoding.BECH32M, False, False, False),
  ('indxt',   17, 32, Encoding.BECH32M, False, False, False),
  ('indxrt',  3,  1, Encoding.BECH32M, False, False, False),
  ('indx',   15, 41, Encoding.BECH32M, False, False, False),
  ('indxt',    0, 16, Encoding.BECH32,  False, False, False),
  ('indxrt',  0, 32, Encoding.BECH32,  True,  False, False),
  ('indx',    0, 16, Encoding.BECH32,  True,  False, False),
  ('indxt',    0, 32, Encoding.BECH32,  False, True,  False),
  ('indxrt',  0, 20, Encoding.BECH32,  False, False, True),
  ('indx',    0, 20, Encoding.BECH32M, False, False, False),
  ('indxt',    0, 32, Encoding.BECH32M, False, False, False),
  ('indxrt',  0, 20, Encoding.BECH32M, False, False, False),
  ('indx',    1, 32, Encoding.BECH32,  False, False, False),
  ('indxt',    2, 16, Encoding.BECH32,  False, False, False),
  ('indxrt', 16, 20, Encoding.BECH32,  False, False, False),
]
