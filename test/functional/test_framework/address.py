...
ADDRESS_BCRT1_UNSPENDABLE = 'indxrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3xueyj'
ADDRESS_BCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(indxrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3xueyj)#juyq9d97'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE 
# Private Key WIF: 8V7Qckc8BygzT55j3fhin7gqbH5sPrbH89iSKQYcmzzHX4w9mAd
# Private Key WIF compressed: a35HEoU2jTDWa51rampjQ8WqUHzVRstJAZTtkEvYucwquEwYtgYr 
ADDRESS_BCRT1_P2WSH_OP_TRUE = 'indx1qeyepxl5evus3x4fqjqlykxdpynxxkuzfqvslknx8kcstzxlf6vwsqqrjzg'
...
def keyhash_to_p2pkh(hash, main=False):
    assert len(hash) == 20
    version = 137 if main else 111
    return byte_to_base58(hash, version)

def scripthash_to_p2sh(hash, main=False):
    assert len(hash) == 20
    version = 139 if main else 196
    return byte_to_base58(hash, version)
...
def program_to_witness(version, program, main=False):
    ...
    return encode_segwit_address("indx" if main else "indxrt", version, program)
