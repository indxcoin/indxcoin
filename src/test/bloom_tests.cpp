...
{
    std::string strSecret = std::string("8UoUyC24FnAsxMKVWScNyG76psmZ7iEUNXbmoaDvtkzaaYTZ14q");
    ...
    std::vector<unsigned char> expected = ParseHex("03d2be5c080000000000000001");
